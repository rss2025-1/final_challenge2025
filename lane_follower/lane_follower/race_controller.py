...
import lane_detector as lane_detector
...
class RacingController(Node):
    def __init__(self):
        ...
        self.declare_parameter("steering_bias", 0.03)       # Bias correction for mechanical veer (positive for right, negative for left)
